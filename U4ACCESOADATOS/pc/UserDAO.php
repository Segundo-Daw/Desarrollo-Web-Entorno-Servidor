...
class UserDAO{
    public static function create($user){
        ...
        $name = $user->getName();
        $pass = $user->getPass();  //$pass tiene la contraseña clara
    ...
    /**
     * verifica si una ocntraseña corresponde con la contraseña de esos nombres en la bd
     * @param mixed $name nombre del usuario
     * @param mixed $pass contraseña introducida que será verificada con la que está guardada en la bd
     * @return int 1 si coinciden, -1 sino existe el user, -2 si existe el user pero la contraseña no es correcta
     */
    public static function verifyPassword($name, $pass): int{
        ...
        if($row != null){
            ...
            if(password_verify($pass, $passBD)){
                $ret =  1;  //user y contraseñacorrectas
            }else{
